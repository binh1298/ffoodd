...
const start = ({ logger, mealGRPCRoute, categoryGRPCRoute, reviewGRPCRoute }) => () =>
  new Promise((resolve, reject) => {
    ...
    server.addService(MealProto.Meal.service, mealGRPCRoute);
    server.addService(CategoryProto.Category.service, categoryGRPCRoute);
    server.addService(ReviewProto.Review.service, reviewGRPCRoute);
